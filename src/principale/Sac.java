...
public class Sac {
	...
	public void setQuantiteScore(HashMap<Character,Integer> list,int [][] tabByScore,int [][] tabByQuantite){
		...
		for (int i=0;i<listJetonTrie.size();i++) {
			...
			cptScore++;
			cptQuantite++;
			SacMap.put(new Jeton(listJetonTrie.get(i), tabByScore[indScore][0]),tabByQuantite[indQuantite][0]);
		}
	 ...
	 *  jetons a jouer. 
	 */
	public ArrayList<Jeton> piocher(int i){
